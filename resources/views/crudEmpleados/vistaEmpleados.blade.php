...
<title>View_Empleados</title>
 <link rel="shortcut icon" href="{{asset('img/icon.png')}}" />
<meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- Main CSS-->
    <link rel="stylesheet" type="text/css" href="{{ asset('bootstrap_4.0/css/main.css') }}">
    <!-- Font-icon css-->
...
<body class="app sidebar-mini rtl">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="index.html"><img height="60px"  width="215px" src="{{asset('img/dicas.png')}}"/></a>
      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">UI Elements</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item" href="{{ route('inicio')}}"><i class="icon fa fa-circle-o"></i> Accion</a></li>
          </ul>
        </li>
    ...
    <script src="{{ asset('bootstrap_4.0/js/jquery-3.2.1.min.js') }}"></script>
    <script src="{{ asset('bootstrap_4.0/js/popper.min.js') }}"></script>
    <script src="{{ asset('bootstrap_4.0/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('bootstrap_4.0/js/main.js') }}"></script>
    <!-- The javascript plugin to display page loading on top-->
    <script src="{{ asset('bootstrap_4.0/js/plugins/pace.min.js') }}"></script>
    <!-- Page specific javascripts-->
    <script type="text/javascript" src="{{ asset('bootstrap_4.0/js/plugins/chart.js') }}"></script>
