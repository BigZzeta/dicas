...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <script src="{{ asset('js/plantilla.js') }}"  type="text/javascript"></script>
                        ...
                        <div class="modal-body" >
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <input id="usr" type="text" class="col-sm-8 form-control" required placeholder="Su usuario..."/>
                                </div>
                                <div class="row">
                                    <div class="col-sm-4 " >Contraseña:</div>
                                    <input id="pass" type="password" class="col-sm-8 form-control" required placeholder="*****"/>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer" >
                            <button id="est" type="button" class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                            <button  type="button" onclick="valida()" class="btn btn-success">Enviar</button>
                        </div>
                    </div>
                </div>
            </div>
            <a id="entrada" href="{{route('bEntrada')}}"></a>
