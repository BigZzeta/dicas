...
<html>
<head>
  <meta charset="utf-8"> <!-- Hi hi ssdwewe-->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/" class="logo">
      ...
      <span class="logo-mini"><b>G</b>TH</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>GESTION </b>TH</span>
    </a>
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
       <!-- aqui iba en main que ahora esta en contenido.blade.php-->
       @yield('content')
    <!-- /.content -->
  </div>
  <!-- /.content-wrapper -->
