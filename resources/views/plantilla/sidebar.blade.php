<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-edit"></i> <span>Catálogos</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="pages/forms/editors.html"><i class="fa fa-circle-o"></i> Colaboradores</a></li>
                    <li><a href="/departamentos"><i class="fa fa-circle-o"></i> Departamentos</a></li>
                    <li><a href="pages/forms/advanced.html"><i class="fa fa-circle-o"></i> Puestos</a></li>
                </ul>
            </li>
            <!-- usuarios -->
            <li class="treeview">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{route('empleados')}}"><i class="fa fa-circle-o"></i> Empleados</a></li>
                    <li><a href="pages/forms/advanced.html"><i class="fa fa-circle-o"></i> Advanced Elements</a></li>
                    <li><a href="pages/forms/editors.html"><i class="fa fa-circle-o"></i> Editors</a></li>
                </ul>
            </li>
